...
def test_tools_sanitize_object_for_json():
    ...
    output = ClientSubmission.sanitize_obj_for_json(test_dict)
    ...
    assert output['date_obj'] == '2023-10-05T23:59:59.999999'
    assert output['datetime_obj'] == '2023-10-05T14:30:00'
    assert output['nested_dict'] == {'inner_key': 'inner_value', 'inner_date': '2024-01-01T23:59:59.999999'}
    assert output['list_of_mixed'] == ['string_in_list', '2025-12-25T23:59:59.999999', {'list_dict_key': 100}]
